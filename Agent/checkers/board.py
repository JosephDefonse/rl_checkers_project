...
class Board:
	...
	def get_possible_moves(self):
		...
		# made adjustment
		# print("self.get_possible_capture_moves(): "+str(self.get_possible_capture_moves()))
		# print("self.get_possible_positional_moves(): "+str(self.get_possible_positional_moves()))
		return self.get_possible_capture_moves()+self.get_possible_positional_moves()
